    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 position-relative">
                    <div class="max-w-xl">
                        <header>
                        ...
                        <form action="{{ route('boxes.destroy', $box->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this box?');" class="position-absolute top-0 end-0 mt-3 me-3">
                            @csrf
                            @method('DELETE')
